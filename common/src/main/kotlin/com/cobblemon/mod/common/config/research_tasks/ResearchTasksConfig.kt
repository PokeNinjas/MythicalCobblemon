...
class ResearchTasksConfig {
    ...
    var taskExamplesForReference = listOf(
        ...
        ResearchTaskConfig("revive"),
        ResearchTaskConfig("revive", amountNeeded=20),
        ResearchTaskConfig("mega_evolve"),
        ResearchTaskConfig("mega_evolve", amountNeeded=20),
        ResearchTaskConfig("raid_defeat"),
        ResearchTaskConfig("raid_defeat", amountNeeded=20),
