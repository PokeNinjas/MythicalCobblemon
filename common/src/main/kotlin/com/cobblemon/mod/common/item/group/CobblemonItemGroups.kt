...
object CobblemonItemGroups {
    ...
    private fun blockEntries(displayContext: ItemDisplayParameters, entries: Output) {
        ...
        entries.accept(CobblemonItems.GREEN_DISPLAY_CASE)
        entries.accept(CobblemonItems.GOLD_DISPLAY_CASE)
        entries.accept(CobblemonItems.PURPLE_DISPLAY_CASE)
        entries.accept(CobblemonItems.WOODEN_DISPLAY_CASE)
        entries.accept(CobblemonItems.RAINBOW_DISPLAY_CASE)
        entries.accept(CobblemonItems.FUTURISTIC_DISPLAY_CASE)
        entries.accept(CobblemonItems.GLASS_DISPLAY_CASE)
        entries.accept(CobblemonItems.NETHERITE_DISPLAY_CASE)
        entries.accept(CobblemonItems.POKE_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_BLUE_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_CYAN_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_GREEN_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_MAGENTA_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_ORANGE_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_PINK_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_PURPLE_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_RED_DISPLAY_CASE)
        entries.accept(CobblemonItems.NEON_YELLOW_DISPLAY_CASE)
