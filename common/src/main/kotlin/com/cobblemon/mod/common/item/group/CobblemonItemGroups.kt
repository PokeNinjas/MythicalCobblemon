...
object CobblemonItemGroups {
    ...
    private fun blockEntries(displayContext: DisplayContext, entries: Entries) {
        ...
        entries.add(CobblemonItems.WOODEN_DISPLAY_CASE)
        entries.add(CobblemonItems.RAINBOW_DISPLAY_CASE)
        ...
        entries.add(CobblemonItems.NEON_BLUE_DISPLAY_CASE)
        ...
        entries.add(CobblemonItems.NEON_PINK_DISPLAY_CASE)
        entries.add(CobblemonItems.NEON_PURPLE_DISPLAY_CASE)
        entries.add(CobblemonItems.NEON_RED_DISPLAY_CASE)
        entries.add(CobblemonItems.NEON_YELLOW_DISPLAY_CASE)
